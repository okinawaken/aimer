package org.dromara.aimer.service.configuration.log.aspect;
...
import org.dromara.aimer.service.configuration.log.event.OperLogEvent;
...
public class LogAspect {
    ...
    public LogAspect(SpringUtil springUtil) {
    ...
    private void setRequestValue(JoinPoint joinPoint, OperLogEvent operLog, String[] excludeParamNames) throws Exception {
        ...
        if (MapUtil.isEmpty(paramsMap)
            ...
            operLog.setOperParam(StringUtils.substring(JsonUtils.toJson(paramsMap), 0, 2000));
        }
    }
    ...
    private String argsArrayToString(Object[] paramsArray, String[] excludeParamNames) {
        ...
        for (Object o : paramsArray) {
            if (ObjectUtil.isNotNull(o) && !isFilterObject(o)) {
                ...
                Map<String, Object> dict = JsonUtils.toHashMap(str);
